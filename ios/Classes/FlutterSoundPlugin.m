...
FlutterMethodChannel* _uiChannel;
...
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer *)player successfully:(BOOL)flag {
    ...
    NSDictionary *fields = @{
                             ...
                             @"file" : [audioFileURL absoluteString],
                             };
    
    NSString *status = [[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:fields
                                                                                      options:0
                                                                                        error:nil]
                                             encoding:NSUTF8StringEncoding];
    
    [_uiChannel invokeMethod:@"audioPlayerDidFinishPlaying" arguments:status];
...
- (void)updateRecorderProgress:(NSTimer*) timer
{
    ...
    [_uiChannel invokeMethod:@"updateRecorderProgress" arguments:status];
}
...
- (void)updateProgress:(NSTimer*) timer
{
    ...
    [_uiChannel invokeMethod:@"updateProgress" arguments:status];
}
...
- (void)updateDbPeakProgress:(NSTimer*) dbPeakTimer
{
    ...
    [_uiChannel invokeMethod:@"updateDbPeakProgress" arguments:normalizedPeakLevel];
}
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    _uiChannel = [FlutterMethodChannel methodChannelWithName:@"flutter_sound/ui"
                                             binaryMessenger:[registrar messenger]];
}
